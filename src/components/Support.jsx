...
const Support = () => {
  return (
    <Container>
      ...
      <Desc>
        By Supporting WBfoudation, you are supporting unfortanate individuals in{" "}
        <br /> Ghana, west Africa. <br />
      ...
      <BoxContainer>
        ...
        <BoxTwo>
          ...
          <BoxDesc>
            Becoming a WBFoundation Team sponsor is a smart and strategic way to
            build brand awareness and strengthen your consumer loyalty
          </BoxDesc>
          <Link
            to="/checkout"
