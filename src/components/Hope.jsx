...
const Container = styled.div`
  height: 80vh;
  background: linear-gradient(to bottom right, #844545e1, #938f8fbc);
    ...
    <Container>
      ...
      <LetterContainer>
        <Letter onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
          H<LetterDesc>Helping</LetterDesc>
        </Letter>

        <Letter onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
          O<LetterDesc>Other</LetterDesc>
        </Letter>
        <Letter onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
          P<LetterDesc>People</LetterDesc>
        </Letter>
        <Letter onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
          E<LetterDesc>Excel</LetterDesc>
        </Letter>
      </LetterContainer>
